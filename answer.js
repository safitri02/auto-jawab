if (window.location.href.search("url soalmu") == -1 && window.location.href.search("gameType=") == -1) {
    if (window.location.href.search("url soalmu") != -1) {
    ...
    } else if (window.location.href.search("url soalmu") != -1) {
